...
class DatabaseSeeder extends Seeder
{
    ...
    private static function seedUsers(){
        ...
        $u1->password = bcrypt('password');
        $u1->administrador = true;
        $u1->proveedor = false;
		$u1->save();
        ...
        $u3 = new User;
		$u3->name='Sin permisos';
		$u3->email = 'sinPermisos@peliculas.com';
        $u3->password = bcrypt('password');
        $u3->administrador = false;
        $u3->proveedor = false;
		$u3->save();
    }
